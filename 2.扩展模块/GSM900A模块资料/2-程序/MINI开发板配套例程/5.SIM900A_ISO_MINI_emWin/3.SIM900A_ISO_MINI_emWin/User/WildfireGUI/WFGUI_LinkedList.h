#ifndef __WFGUI_LINKEDLISH_H
#define __WFGUI_LINKEDLISH_H
 ...
 */
static __inline void __list_add(struct list_head *new_node, struct list_head *prev,struct list_head *next)
{
	next->prev = new_node;
	new_node->next = next;
	new_node->prev = prev;
