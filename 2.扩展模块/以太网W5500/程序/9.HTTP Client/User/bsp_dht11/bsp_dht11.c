...
* @date    		2015-xx-xx
* @brief   		
* @attention	实验平台：野火 ISO-MINI STM32 开发板
*********************************************************************************************************
*/
...
{			
  ...
  GPIO_Init(DHT11_PORT, &GPIO_InitStructure);		  	/*调用库函数，初始化DHT11_PORT*/
	...
	GPIO_SetBits(DHT11_PORT, DHT11_PIN);	 			/*拉高GPIOB10*/
}
...
{  
	...
	DHT11_DATA_OUT(DHT11_LOW);						/*主机拉低*/
	
	delay_ms(18);						
		
	DHT11_DATA_OUT(DHT11_HIGH); 						/*总线拉高，主机延时*/
	...
	if(DHT11_DATA_IN()==Bit_RESET)     
	{
		...
		DHT11_DATA_OUT(DHT11_HIGH);					/*主机拉高*/
