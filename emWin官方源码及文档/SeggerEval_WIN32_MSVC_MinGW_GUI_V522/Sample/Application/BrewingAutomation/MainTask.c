...
----------------------------------------------------------------------
File        : MainTask.c
Content     : emWin Beer Demonstration
---------------------------END-OF-HEADER------------------------------
*/
#include <stddef.h>
#include "WM.h"
...
static void _DrawMovingBitmapClipRect(GUI_CONST_STORAGE GUI_BITMAP * pBitmap,
                                                               ...
                                                               int   StepDist, // Distance of a single step, use negative values to turn direction
                                                               int   MovDir) { // 0 == x; 1 == y;
  int Stop = 0;
  GUI_RECT Rect = {ClipRectX0, ClipRectY0, ClipRectX1, ClipRectY1};
...
*       MainTask
*
*       This sample needs approximately 1 MB of memory
*/
void MainTask(void);
void MainTask(void) {
  WM_HWIN            hWinBk;
