...
static void _CreateBackGround(void) {
  ...
  GUI_SetBkColor(GUI_BLACK);
  GUI_Clear();
  _DrawFrame(230, 170, 230, 170, 285, 1, 0x444444, GUI_BLACK);
  _DrawFrame(230, 170, 229, 169, 284, 1, 0x808080, GUI_BLACK);
  _DrawFrame(230, 170, 228, 168, 283, 1, 0xA0A0A0, GUI_BLACK);
  _DrawFrame(230, 170, 227, 167, 282, 1, 0xC0C0C0, GUI_BLACK);
  _DrawFrame(230, 170, 226, 166, 281, 1, 0xA0A0A0, GUI_BLACK);
  _DrawFrame(230, 170, 225, 165, 280, 1, 0x808080, GUI_BLACK);
  _DrawFrame(230, 170, 224, 164, 279, 1, 0x444444, GUI_BLACK);
