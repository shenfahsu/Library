...
*       _DrawLogo
*/
static void _DrawLogo(int xSize, int ySize, GUI_MEMDEV_Handle hLogo, GUI_MEMDEV_Handle hMemWork, GUI_RECT * pRect) {
...
static void _Paint0(int xSize, int ySize, GUI_MEMDEV_Handle hLogo, GUI_MEMDEV_Handle hMemWork) {
  ...
  _DrawLogo(xSize, ySize, hLogo, hMemWork, &rLogo);
  //
  // Message
  //
  rText.x0 = 25;
...
static void _DrawResult(int xSize, int ySize, int ResultDrawing, int ResultFading, int ResultTotal) {
  ...
  const char * apString[] = { acDrawing, acFading, acTotal };
  int  * apValues[] = { &ResultDrawing, &ResultFading, &ResultTotal };
  int i, xMid, yMid, ySizeFont, ySizeTotal, xPosText, yPosText, xSizeText, xSizeLabel, xSizeValue, xSizeTotal;
...
void MainTask(void);
void MainTask(void) {
  int xSize, ySize, i, j, TimeStart, TimeNow, Cnt, ResultFading, ResultDrawing, ResultTotal;
  GUI_MEMDEV_Handle hMemWork, hLogo;
