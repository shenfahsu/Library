...
static GUI_MEMDEV_Handle _CreateReflex(int r, int dy, int a, U32 Color, U8 Intens) {
  GUI_MEMDEV_Handle hMemGradient, hMemReflex, hMemRot;
  int xSize, ySize, i, Index;
  U32 * pData;
  U32 NumPixels;

  xSize = ySize = r * 2 + 1;
  hMemGradient = GUI_MEMDEV_CreateFixed(0, 0, 64 * 2 + 1, 64 * 2 + 1, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV_8888);
  //
  ...
  //
  hMemReflex = GUI_MEMDEV_CreateFixed(0, 0, (r << 1) + 1, (r << 1) + 1, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV_8888);
  ...
  //
  if (a) {
    hMemRot = GUI_MEMDEV_CreateFixed(0, 0, (r << 1) + 1, (r << 1) + 1, GUI_MEMDEV_NOTRANS, GUI_MEMDEV_APILIST_32, GUI_COLOR_CONV_8888);
