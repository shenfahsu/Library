...
Purpose     : Shows how to use the window effect functions
----------------------------------------------------------------------
*/
...
static const char * _apIntro[] = {
  "This demo shows how to use the effect functions of emWin for fading and moving effects for any kind of window..."
};
...
void MainTask(void) {
  ...
  WM_Exec();
  hIntro = WM_CreateWindow(40, 60, 240, 120, WM_CF_HASTRANS, _cbIntro, 0);
