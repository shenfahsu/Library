  ...
  case WM_NOTIFY_PARENT:
    ...
    case GUI_ID_EDIT0: // Notifications sent by 'Edit'
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
				messagesEE[0]=WM_GetDialogItem(pMsg->hWin, GUI_ID_EDIT0);
				messagesEE[1]=GUI_ID_EDIT0;
    ...
    case GUI_ID_EDIT1: // Notifications sent by 'Edit'
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
				messagesEE[0]=WM_GetDialogItem(pMsg->hWin, GUI_ID_EDIT1);
				messagesEE[1]=GUI_ID_EDIT1;
				if(!keypadflag)OSTaskQPost(&AppTaskKeypadTCB,
																(void *)&messagesEE,
																2,
																OS_OPT_POST_FIFO,
    ...
    case GUI_ID_EDIT2: // Notifications sent by 'Edit'
      ...
      case WM_NOTIFICATION_RELEASED:
        // USER START (Optionally insert code for reacting on notification message)
				messagesEE[0]=WM_GetDialogItem(pMsg->hWin, GUI_ID_EDIT2);
				messagesEE[1]=GUI_ID_EDIT2;
				if(!keypadflag)OSTaskQPost(&AppTaskKeypadTCB,
																(void *)&messagesEE,
																2,
																OS_OPT_POST_FIFO,
