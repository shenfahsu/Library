...
*/
                                                            ...
                                                            /* --------------------- MISCELLANEOUS ------------------ */
#define  OS_CFG_MSG_POOL_SIZE            100u               //消息池的消息数
...
#define  OS_CFG_TASK_STK_LIMIT_PCT_EMPTY  10u               /* Stack limit position in percentage to empty            */
                                                            ...
                                                            /* ---------------------- IDLE TASK --------------------- */
#define  OS_CFG_IDLE_TASK_STK_SIZE       128u               //中断提交任务的堆栈栈大小（单位：CPU_STK）


                                                            /* ------------------ ISR HANDLER TASK ------------------ */
#define  OS_CFG_INT_Q_SIZE                10u               //中断队列的大小
#define  OS_CFG_INT_Q_TASK_STK_SIZE      128u               //中断提交任务的堆栈大小（单位：CPU_STK）


                                                            /* ------------------- STATISTIC TASK ------------------- */
#define  OS_CFG_STAT_TASK_PRIO            11u               //统计任务的优先级
#define  OS_CFG_STAT_TASK_RATE_HZ         10u               //统计任务的执行频率（单位：Hz），决定更新统计信息的时间
#define  OS_CFG_STAT_TASK_STK_SIZE       128u               //统计任务的堆栈大小（单位：CPU_STK）
